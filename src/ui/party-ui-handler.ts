          ...
          if (filterResult === null) {
            ...
            if (this.selectCallback && this.partyUiMode !== PartyUiMode.CHECK) {
              ...
              if (
                ...
                && globalPhaseManager.getCurrentPhase()?.is<SelectModifierPhase>(PhaseId.SELECT_MODIFIER)
              ) {
    ...
    if (
      ...
      switch (this.partyUiMode) {
        ...
        case PartyUiMode.CHECK:
          if (globalPhaseManager.getCurrentPhase()?.is<SelectModifierPhase>(PhaseId.SELECT_MODIFIER)) {
