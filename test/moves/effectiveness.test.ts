...
describe("Moves - Type Effectiveness", () => {
  ...
  it.todo("Electric-type attacks are super-effective against Tera-Water Pokemon", () =>
  ...
  it.todo("Powder moves have no effect on Tera-Grass Pokemon", () =>
  ...
  it.todo("Prankster-boosted status moves have no effect on Tera-Dark Pokemon", () => {
    game.override.ability(Abilities.PRANKSTER);
